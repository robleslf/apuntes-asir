...
# Crear una instancia de gTTS con el texto extraído y la voz deseada
voz_espanol = 'es-es'  # Cambia esto al identificador de voz que desees
tts = gTTS(text=texto_del_pdf, lang=voz_espanol)
